// TypeScript shims for Lovable's version-pinned import specifiers.
// The codebase uses imports like "lucide-react@0.487.0" (resolved at runtime via Vite alias).
// These declarations make TypeScript understand those module specifiers.
