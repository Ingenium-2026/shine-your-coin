      ...
      <MobileNav className="bg-card/80 dark:bg-card/80 backdrop-blur-sm border-b border-border">
        <MobileNavHeader>
          ...
          >
            ...
            <span className="text-xs text-neutral-400">Cyber Resilience</span>
          </a>
        ...
        >
          {navItems.map((item, idx) => (
            <a
              ...
              className={`relative py-2 text-neutral-300 hover:text-white transition-colors ${
                (item.link === "#dashboard" && currentScreen === "dashboard") ||
                (item.link === "#incidents" && currentScreen === "incidents")
