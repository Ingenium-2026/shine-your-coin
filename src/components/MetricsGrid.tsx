    ...
    <section>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="p-4 bg-white border border-neutral-200 rounded-lg">
          <div className="text-sm text-neutral-500 mb-1">Events/sec</div>
          <div className={`text-2xl font-semibold ${demoState !== 'normal' ? 'text-red-600' : 'text-neutral-900'}`}>
            {metrics.eventsPerSec.toLocaleString()}
          </div>
        </div>

        <div className="p-4 bg-white border border-neutral-200 rounded-lg">
          <div className="text-sm text-neutral-500 mb-1">Current RPS</div>
        ...
        <div className="p-4 bg-white border border-neutral-200 rounded-lg">
          ...
          <div className={`text-2xl font-semibold ${metrics.latency > 50 ? 'text-amber-600' : 'text-neutral-900'}`}>
            {metrics.latency}ms
          </div>
        </div>
        ...
        <div className="p-4 bg-white border border-neutral-200 rounded-lg">
          ...
          <div className={`text-2xl font-semibold ${metrics.errorRate > 5 ? 'text-red-600' : 'text-neutral-900'}`}>
            {metrics.errorRate}%
          </div>
        </div>

        <div className="p-4 bg-white border border-neutral-200 rounded-lg">
          <div className="text-sm text-neutral-500 mb-1">Detection Time</div>
          <div className="text-2xl font-semibold text-neutral-900">
